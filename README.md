...
The [Clack-based scaffolder, `create-easel-theme`](packages/create-easel) creates a theme with TypeScript or JavaScript, optional Alpine, React or Vue, and plain CSS or Tailwind. It includes generic templates for the standard storefront page types while leaving current customer accounts to Shopify.
